...
#-- Author:   JBALLARD (JEB)                                                                                    :
#-- Date:     2023.3.23                                                                                         :
#-- Script:   THM-ROBV39-5.SEAL.FAIL.py                                                                         :
#-- Purpose:  A python script sets a Seal Failure Alarm for ROBV E_03_39-5.                                     :
#-- Info:     E_03_39-5_SF; 10367; 40001; Normal = 34; Alarm = 35.                                              :
#-- Version:  1.0                                                                                               :
#-- ************************************************************************************************************:
#-- ************************************************************************************************************:
#--
#--python -m pip install PyModbus ModbusTcpClient
#--
#-- ****************************************************:
...
client = ModbusTcpClient('10.165.3.40', port=10367)
#--
